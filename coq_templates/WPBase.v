...
Computation of characteristic formulae.
Needed only if we go for x-tactics that don't operate directly on monadic terms.
Could be simplified if handling only purely functional code.
